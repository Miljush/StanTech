...
const EditOglasPage = ({ oglas,izmenjen,setIzmenjen }) => {
  ...
  useEffect(() => {
    setBrojSoba(oglas.brojSoba);
    setIme(oglas.ime);
    setAdresa(oglas.adresa);
    setDodateSlike(oglas.putanja_slike);
    setOpis(oglas.opis);
    setTipGrejanja(oglas.tipGrejanja);
    setPovrsina(oglas.povrsina);
    setCena(oglas.cena);
    setDodaci(oglas.dodaci);
